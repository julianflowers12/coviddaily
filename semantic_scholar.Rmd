...
corp_samp <- corpus_sample(corp1, 20000)
dfm1 <- dfm(corp_samp, remove = stopwords("en"), remove_punct = TRUE, remove_numbers = TRUE, stem = TRUE, remove_symbols = TRUE, ngrams = 1:2)
#dfm1 <- dfm_tfidf(dfm1)
...
fit_stm <- stm(stm$documents, stm$vocab, data = stm$meta, K = 30, init.type = "Spectral")
